...
export const DashboardClient = (props: { className?: string }) => {
  ...
  return (
      ...
      <div className={cn(props.className, "flex flex-col flex-1 p-4 bg-white text-slate-900 border rounded-xl shadow-sm md:h-full")}>
        ...
        <div className="flex-1 overflow-y-auto space-y-3 mb-4 pr-2">
          {messages.map((m) => (
            <div
              key={m.id}
              className={`p-3 rounded-lg max-w-fit ${m.role === "user"

...
function Menubar({ className, ...props }: MenubarPrimitive.Props) {
  return (
    <MenubarPrimitive
      data-slot="menubar"
      className={cn(
        "flex h-8 items-center rounded-2xl border p-0.75",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "flex items-center rounded-2xl px-1.5 py-0.5 text-sm font-medium outline-hidden select-none hover:bg-muted aria-expanded:bg-muted",
        className
      )}
      {...props}
    />

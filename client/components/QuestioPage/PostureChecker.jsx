...
export default function PostureChecker() {
  ...
  onFrame: async () => {
    // Check if the video element exists and has loaded data
 ...
 function onResults(results) {
  ...
  function handleContinue() {
    ...
    dispatch(setField( {key: 'posture', value: {
      score:  best?.score  ?? 0,
      checks: best?.checks ?? {},
  ...
  return (
    <div style={{ padding: " ", maxWidth: 640, margin: "0 auto" }}>
  {!started ? (
    <div style={{ 
      textAlign: "center", 
      padding: "3rem 2rem", 
      ...
      {/* Simple Description */}
      <p style={{ fontSize: "18px", color: "#374151", marginBottom: "24px", lineHeight: "1.5" }}>
        We use your camera and AI to help you sit straighter. 
        <br />
        <span style={{ fontWeight: "600", color: "#059669" }}>✓ Private: Your video never leaves this computer.</span>
      </p>

      {/* Action Button - Big and Easy to Click */}
      <button 
      ...
      {/* Instructions - Higher Contrast and Icons */}
      <div style={{ marginTop: "32px", padding: "16px", backgroundColor: "#fff", borderRadius: "8px", border: "1px solid #ddd" }}>
        ...
        <ul style={{ textAlign: "left", fontSize: "15px", color: "#4b5563", listStyle: "none", padding: 0 }}>
          <li style={{ marginBottom: "8px" }}>🪑 <strong>Sit sideways</strong> to the camera.</li>
          <li>👤 Make sure we can see your <strong>head and shoulders.</strong></li>
        </ul>
      </div>
    </div>
      ) : (

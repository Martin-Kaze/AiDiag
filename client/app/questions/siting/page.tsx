...
<QuestionPhoto image={["/images/siting-1.png" , "/images/siting-2.png" , "/images/siting-3.png"]} route={'questions/stading'} />

  </div>

    <ButtonPushRoute route='/questions/standing' classname="" text='NEXT'/>

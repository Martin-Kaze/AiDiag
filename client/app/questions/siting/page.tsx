...
import TypeWriter from "@/components/FirstPage/TypeWriter";
...
export default function Home() {
  ...
  return (
    ...
    <QuestionPhoto image={["/images/siting-1.jpeg" , "/images/siting-2.jpeg" , "/images/siting-3.jpeg"]} route={'questions/stading'} />
